...
namespace Sydewa
{
    ...
    public class LightingManager : MonoBehaviour
    {
        ...
        // Public properties to give other scripts read-only access to time and intervals
        public float CurrentTimeInHours => TimeOfDay;
        public float MorningStartHour => morningInterval.x * 24f;
        public float MorningEndHour => morningInterval.y * 24f;
        public float AfternoonStartHour => afterNoonInterval.x * 24f;
        public float AfternoonEndHour => afterNoonInterval.y * 24f;
